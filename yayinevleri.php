...
if(isset($_GET["sil"]))
{
   ...
   $sql = "DELETE FROM yayinevi WHERE id = '{$silinecekID}'";
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Yayıevleri Yönetim Paneli </h1><a href="yayinevleriekle.php" class="pull-right">Yeni Yayınevi Ekle</a>
		<div class="row">
		<table class="table">
			<thead>
				<tr>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		...
		<td><?php echo $row['yayinevi']; ?></td>
					<td>
						<a href="yayinevleri.php?sil=<?php echo $row['id']; ?>"> <i class="fa fa-eraser"></i> Sil</a>
						<a href="yayinevleriduzenle.php?duzenle=<?php echo $row['id']; ?>"> <i class="fa fa-edit"></i> Düzenle</a>
					</td>
					</tr>
		<?php
